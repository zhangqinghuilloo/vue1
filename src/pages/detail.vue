        ...
        <div class="content">
          ...
          <div class="item-total">
            <div class="phone-info clearfix">
              <div class="fl ms">{{product.name}} {{version==1?'6GB+64GB 全网通':'4GB+64GB 移动4G'}} 深灰色</div>
              <div class="fr yuan">{{product.price}}元</div>
            </div>
