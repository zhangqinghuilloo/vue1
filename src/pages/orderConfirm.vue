...
.addr-info .action .icon{
                  width: 20px;
                  height: 20px;
                  fill: #666666;
                  vertical-align: middle;
}
.addr-info .action .icon :hover{
                    fill: #FF6700;
                  }
.addr-info .checked{
...
.item-good li .good-name{
              flex:5;
}
.item-good li .good-name img{
                width:30px;
                height:30px;
                vertical-align:middle;
              }
...
.item-shipping,.item-invoice h2{
           
            margin-right: 71px;
            font-size: 20px;
            width: 80px;
          }
.item-shipping,.item-invoice span,a{
            font-size:16px;
            color:#FF6700;
            margin-right:23px;
...
.detail .item-total .item-val{
              font-size:28px;
            }
.detail .item-total .item-name{
                display: inline-block;
            }
.btn-group{
          margin-top: 37px;
